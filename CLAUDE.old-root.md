...
## Delegation a Codex (configuration locale Windows)

L'utilisateur autorise Claude Code a deleguer des sous-taches a Codex pour English Quest. Claude reste coordinateur et valide les changements avant integration.

Lanceur local : C:/Users/damien/Documents/Codex/2026-09-12/je-x20/outputs/claude-codex/delegate.mjs

Depuis un terminal Windows avec Node.js, Git et Codex accessibles :

node "C:/Users/damien/Documents/Codex/2026-09-12/je-x20/outputs/claude-codex/delegate.mjs" "C:/Users/damien/Desktop/Code Github" "CHEMIN_ABSOLU_MISSION_UTF8.txt"

Ecrire d'abord une mission bornee dans un fichier UTF-8 hors du depot : objectif, fichiers concernes et criteres de reussite. Le lanceur cree une copie Git independante avec les modifications locales et les fichiers non ignores, puis un commit de reference uniquement dans cette copie. Suspendre les editions pendant cette breve copie. Les fichiers ignores, notamment les dependances, ne sont pas copies. Les changements du site original ne sont ni commites ni publies.

Lire le dossier de resultat annonce : metadata.json, result.md et checkout. Comparer les changements au commit snapshot de metadata.json, examiner aussi les nouveaux fichiers et integrer seulement la mission validee. Ne pas fusionner aveuglement le commit de snapshot. Tester l'ensemble apres integration.

Codex conserve son modele configure et utilise workspace-write avec refus des permissions supplementaires. Ne pas desactiver le sandbox pour contourner un blocage. Si codex est absent du PATH, definir CODEX_EXECUTABLE au chemin de codex.exe retourne par Get-Command codex dans le terminal Windows. Verifier codex login status.

Etat : lanceur prepare et syntaxe validee ; test reel de delegation non effectue. La session de configuration Codex ne parvient pas a charger le dossier utilisateur pour le CLI. Si Claude travaille dans une VM ou un conteneur sans acces au terminal Windows, cette commande locale n'est pas directement utilisable : signaler ce point avant de lancer la mission.
